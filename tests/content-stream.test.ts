...
test('SSE assembles fragmented function names, Japanese arguments and retains usage without reasoning', async () => {
    ...
    assert.deepEqual(result.usage, { prompt_tokens: 100, completion_tokens: 25, total_tokens: 125 });
