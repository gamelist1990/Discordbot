...
import RequestManagerPage from './pages/Staff/RequestManager/RequestManager';
    ...
    <div className="appFrame">
      ...
      <main className="appMain">
        <Routes>
          ...
          <Route path="/staff/requestmanager" element={<StaffGuard><RequestManagerPage /></StaffGuard>} />
