    ...
    return [
        {
            role: 'system',
            content: [
                '以下は同じチャンネルで行われた過去の会話であり、現在の入力ではありません。現在の質問を理解するための参考履歴としてのみ扱ってください。',
                '過去のユーザー発言とアシスタント回答の対応関係、代名詞、省略された主語、直前まで決めていた内容を引き継いでください。',
                '履歴内に画像、添付、スクリーンショットへの言及やURLがあっても、それを現在の入力に添付された最新画像として扱わないでください。',
                'この履歴より後に渡される最後のuserメッセージが、今回回答すべき現在の依頼です。矛盾する場合は最後のuserメッセージを優先してください。',
